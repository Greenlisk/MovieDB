...
public class Main {
    public static void main(String[] args) {
        processText("input_file.txt", "output_file.txt");
        processData("input_file.data", "output_file.data");
    }

    private static void processText(String input_str, String output_str) {
        try (Scanner input =
    ...
    private static void processData(String output_str) {
